...
/******************************************************************************
 * Note: Added "byte[] content" to the class
 * 
...
namespace Amazon.S3.Model
{
    ...
    public class GetObjectResponse : S3Response
    {
        ...
        /// This is the byte array type contnet of the S3 object
        /// </summary>
        public byte[] Content
        {
            get { return _content; }
        ...
        public void WriteResponseStreamToFile(string fileName)
        {
            WriteResponseStreamToFile(fileName, false);
        }
        ...
        public void WriteResponseStreamToFile(string fileName, bool append)
        {
            StreamReader reader = null;
            try
            {
                reader = new StreamReader(new StreamResourceInfo(this.ResponseStream, null).Stream);
                
                using (BinaryReader bReader = new BinaryReader(reader.BaseStream))
                {
                    _content = bReader.ReadBytes((int)reader.BaseStream.Length);
                    bReader.Close();
                }
